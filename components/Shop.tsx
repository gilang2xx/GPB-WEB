      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {products.map((product) => (
            <div
              key={product.id}
              className="group relative bg-gray-50 dark:bg-neutral-900 overflow-hidden transform transition-all hover:-translate-y-2"
            >
              ...
              <div className="relative h-96 overflow-hidden">
                ...
                {/* Category Badge */}
                <div className="absolute top-4 left-4 bg-gpb-blue text-white px-3 py-1 font-teko normal-case text-lg transform -skew-x-12">
                  <span className="transform skew-x-12 block">{product.category}</span>
                </div>

                {/* Discount Badge */}
                <div className="absolute top-4 right-4 bg-gpb-orange text-white px-3 py-1 font-teko normal-case text-lg transform -skew-x-12">
                  <span className="transform skew-x-12 block">Sale</span>
                </div>
              ...
              <div className="p-6 border-b-4 border-transparent group-hover:border-gpb-orange transition-colors bg-white dark:bg-neutral-900 relative z-10">
                <h3 className="text-3xl font-teko font-bold normal-casetext-black dark:text-white mb-2 leading-none">
                  {product.name}
                </h3>

                <div className="flex items-center gap-3 mt-2">
                  <span className="text-2xl font-satoshi font-bold text-gpb-orange">
                    {product.price}
                  </span>
                  <span className="text-lg font-satoshi text-gray-400 line-through">
                ...
                <div className="mt-4 md:hidden">
                  <button
                    ...
                    className="w-full bg-gpb-blue text-white font-teko normal-case text-xl py-2"
                  >
                    Buy on WhatsApp
                  </button>
                </div>
